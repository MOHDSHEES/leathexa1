                ...
                <ul className="py-2 text-start">
                  ...
                  <li className="ms-0">
                    <p className="flex items-center font-medium py-2 px-4">
                      <FiDollarSign className="h-4 w-4 me-2"></FiDollarSign>{" "}
                      Balance:{" "}
                  ...
                  <li className="ms-0">
                    <Link
                      ...
                      className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-orange-500 dark:hover:text-white"
                    >
                      <FiHelpCircle className="h-4 w-4 me-2"></FiHelpCircle>
                      Helpcenter
                    </Link>
                  </li>
                  <li className="ms-0">
                    <Link
                      ...
                      className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-orange-500 dark:hover:text-white"
                    >
                      <FiSettings className="h-4 w-4 me-2"></FiSettings>Settings
                    </Link>
                  </li>
          ...
          >
            ...
            >
              ...
              >
                ...
                <li
                  className={`ms-0 ${
                    manu === "/index-fashion-three" ? "active" : ""
                  }`}
                >
                ...
                <li
                  className={`ms-0 ${
                    manu === "/index-fashion-four" ? "active" : ""
                  }`}
                >
              ...
              >
                ...
                >
                  <Link
                    href="#"
                    onClick={() =>
                      setSubManu(setManu === "/grid-item" ? "" : "/grid-item")
                    }
                  >
                    {" "}
                    Shop Grid{" "}
                  ...
                  >
                    ...
                    <li
                      className={`ms-0 ${
                        manu === "/shop-grid-left-sidebar" ? "active" : ""
                      }`}
                    >
                      <Link
                    ...
                    <li
                      className={`ms-0 ${
                        manu === "/shop-grid-right-sidebar" ? "active" : ""
                      }`}
                    >
                      <Link
                ...
                >
                  <Link
                    href="#"
                    onClick={() =>
                      setSubManu(setManu === "/list-item" ? "" : "/list-item")
                    }
                  >
                    {" "}
                    Shop List{" "}
                  ...
                  >
                    ...
                    <li
                      className={`ms-0 ${
                        manu === "/shop-list-left-sidebar" ? "active" : ""
                      }`}
                    >
                      <Link
                    ...
                    <li
                      className={`ms-0 ${
                        manu === "/shop-list-right-sidebar" ? "active" : ""
                      }`}
                    >
                      <Link
                ...
                >
                  <Link
                    ...
                    onClick={() =>
                      setSubManu(
                        setManu === "/detail-item" ? "" : "/detail-item"
                      )
                    }
                  >
                    {" "}
                  ...
                  >
                    <li
                      className={`ms-0 ${
                        manu === "/product-detail-one" ? "active" : ""
                      }`}
                    >
                      <Link
                        href="/product-detail-one"
                        className="sub-menu-item"
                      >
                        Product Detail One
                      </Link>
                    ...
                    <li
                      className={`ms-0 ${
                        manu === "/product-detail-two" ? "active" : ""
                      }`}
                    >
                      <Link
                        href="/product-detail-two"
                        className="sub-menu-item"
                      >
                        Product Detail Two
                      </Link>
                    ...
                    <li
                      className={`ms-0 ${
                        manu === "/product-detail-three" ? "active" : ""
                      }`}
                    >
                      <Link
                        href="/product-detail-three"
                        className="sub-menu-item"
                      >
                        Product Detail Three
                      </Link>
                ...
                <li className={`ms-0 ${manu === "/shop-cart" ? "active" : ""}`}>
                ...
                <li className={`ms-0 ${manu === "/our-store" ? "active" : ""}`}>
                  <Link href="/our-store" className="sub-menu-item">
                    Our Store
                  </Link>
                </li>
                <li className={`ms-0 ${manu === "/brands" ? "active" : ""}`}>
                ...
                <li
                  className={`ms-0 ${
                    manu === "/recently-viewed-product" ? "active" : ""
                  }`}
                >
                  <Link
                    href="/recently-viewed-product"
                    className="sub-menu-item"
                  >
                    Recently Viewed Products
                  </Link>
            ...
            >
              ...
              >
                <li className={`ms-0 ${manu === "/aboutus" ? "active" : ""}`}>
                ...
                >
                  <Link
                    href="#"
                    onClick={() =>
                      setSubManu(setManu === "/user-item" ? "" : "/user-item")
                    }
                  >
                    {" "}
                    My Account
                ...
                >
                  <Link
                    href="#"
                    onClick={() =>
                      setSubManu(setManu === "/email-item" ? "" : "/email-item")
                    }
                  >
                    {" "}
                    Email Template{" "}
                ...
                <li className={`ms-0 ${manu === "/career" ? "active" : ""}`}>
                ...
                >
                  <Link
                    href="#"
                    onClick={() =>
                      setSubManu(setManu === "/auth-item" ? "" : "/auth-item")
                    }
                  >
                    {" "}
                    Auth Pages{" "}
                ...
                <li
                  className={`has-submenu parent-menu-item ms-0 ${
                    ["/multi-item", "/multi-item2", "/multi-item3"].includes(
                      manu
                    )
                      ? "active"
                      : ""
                ...
                >
                  <Link
                    href="#"
                    onClick={() =>
                      setSubManu(setManu === "/multi-item" ? "" : "/multi-item")
                    }
                  >
                    {" "}
                    Multi Level Menu
                  ...
                  >
                    <li className="ms-0">
                      <Link
                        ...
                        onClick={() =>
                          setSubManu(
                            setManu === "/multi-item2" ? "" : "/multi-item2"
                          )
                        }
                        className="sub-menu-item"
                      >
                    ...
                    <li
                      className={`has-submenu child-menu-item ms-0 ${
                        ["/multi-item3"].includes(manu) ? "active" : ""
                      }`}
                    >
                      <Link
                        href="#"
                        onClick={() =>
                          setSubManu(
                            setManu === "/multi-item3" ? "" : "/multi-item3"
                          )
                        }
                      >
                        {" "}
                      ...
                      <ul
                        className={`submenu ${
                          ["/multi-item3"].includes(subManu) ? "open" : ""
                        }`}
                      >
                        <li className="ms-0">
                          <Link href="#" className="sub-menu-item">
